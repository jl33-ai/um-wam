...
def render_toolbar():
    with st.container():
        ...
        with btn_add_subject:
            btn_add_subject = st.button('Add Subject', on_click=handle_add_grade)

        with btn_remove_subject:
            btn_remove_subject = st.button('Add Pass/Fail Subject', on_click=handle_add_pass_fail_subject)

        with btn_add_pass_fail_subject:
            btn_add_pass_fail_subject = st.button('Remove Subject', on_click=handle_remove_grade)
